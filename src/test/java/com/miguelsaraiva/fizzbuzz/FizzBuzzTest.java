...
public class FizzBuzzTest {
    ...
    public void testInvalidRange()
    {
        ...
        assertEquals("Invalid input (end is bigger then start)", outContent.toString());
    }
    ...
    public void testINegativeIncludedRange()
    {
        ...
        assertEquals("fizzbuzz -14 -13 fizz -11 buzz fizz -8 -7 fizz buzz -4 fizz -2 -1 fizzbuzz 1 2 fizz 4 buzz fizz 7 8 fizz buzz 11 fizz 13 14 fizzbuzz", outContent.toString());
    }
    ...
    public void testInvalidInputType()
    {
        ...
        assertEquals("Invalid input", outContent.toString());
    }
    ...
    public void testInvalidNumberOfArguments()
    {
        ...
        assertEquals("Invalid number of arguments", outContent.toString());
    }
